...
к 19.03.2026
1 проиниициализировать гитпроект и залить на гитхаб
2 все новые домашки оформлять в отдельной девелоп ветке в несколькиих коммитах и выставлять пул реквест в мастер.
3 отладить запуск кубернетис. изучить детально все манифесты, быть готовой ответить по каждой строке
4 проштудировать функц интерфейсы
